...
public class Two_D_Exp_Left_LowerDiagonal // left lower diagonal addition
{
	...
	public void sumLower(int a[][])
	{
		...
		System.out.println("Sum of lower daigonal is  "+sum);
	...
	public static void main(String[] args)
	{
		...
		Two_D_Exp_Left_LowerDiagonal st =new Two_D_Exp_Left_LowerDiagonal();
		st.sumLower(a);
	}
}
