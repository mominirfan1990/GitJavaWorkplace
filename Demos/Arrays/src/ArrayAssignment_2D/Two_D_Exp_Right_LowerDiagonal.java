...
public class Two_D_Exp_Right_LowerDiagonal 
{
	...
	public void sumLower(int a[][])
	{
		...
		System.out.println("Sum of Right Lower daigonal is  "+sum);
	...
	public static void main(String[] args)
	{
		...
		Two_D_Exp_Right_LowerDiagonal st =new Two_D_Exp_Right_LowerDiagonal();
		st.sumLower(a);
	}
}
